            ...
            <div class="col-md-8">
              <div class="blog-archive-left">
                ...
                <article class="blog-news-single">
                  @isset($articles->image)    
                  <div class="blog-news-img">
                    <img src="{{asset('img/'.$articles->image)}}" alt="image">
                  </div>
                  @endisset
                  <div class="blog-news-title">
                    <h2>{{$articles->title}}</h2>
                    <p>By <a class="blog-author" href="#">{{$articles->user->name}}</a> <span class="blog-date">| {{ $articles->created_at->format('j F Y') }}</span> | <i class="fa fa-eye"></i> {{$articles->viewcount}}</p>
                  </div>
                ...
                <div class="blog-navigation-area">
                  @isset($prev)
                    <div class="blog-navigation-prev">
                      <a href="{{ url('/artikel/view',$prev->slug) }}">
                  ...
                  @isset($next)    
                    <div class="blog-navigation-next">
                      <a href="{{ url('/artikel/view',$next->slug) }}">
